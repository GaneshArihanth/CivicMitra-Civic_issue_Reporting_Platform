...
_Note the deployed contract address and update it in your Frontend configuration if necessary._
...
3.  Open in Android Studio:
    ...
    ```
    _From Android Studio, you can run the app on a connected device or emulator._
